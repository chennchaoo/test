...
<link href="css/style.css?t=12" type="text/css" rel="stylesheet" media="all" />
...
$(document).ready(function(){
	...
	$.ajax({
		type : "POST",
		dataType : "json",
		url : 'http://api20.taskou.com/c/casio3/detail_photo.php',
		data:'photo_id='+photo,
...
<div class="bg_details" style="display:block">
    ...
    <div class="details_da">
        ...
        <!--<div class="details_da_zanren">
            ...
            <div class="details_da_zanren_shuliang" style="display:block;">1210</div>
            <div class="details_da_zanren_shuliang_2" style="display:none;">0</div>
        </div>
        -->
